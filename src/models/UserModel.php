...
class UserModel extends BaseModel {
    ...
    public function __construct(Connection $connection) {
        ...
        $this->addColumns("ID", "NOMBRE", "PASSWORD", "TIPO_USUARIO", "ACTIVO", "EMAIL", "DPTO", "PAIS", "CIUDAD", "MOVIL", "TELEFONO", "DIRECCION", "DOC_IDENT", "NOMBRES", "APELLIDOS", "CARGO", "TIPO_DOC", "INFORMA_A", "FECHA_CREA", "USER_CREA", "IP_CREA", "FECHA_MODI", "USER_MODI", "IP_MODI","RMEDICO","FIRMA");
    }
